...
var Select = _react2['default'].createClass({
	...
	propTypes: {
		...
		positionValue: _react2['default'].PropTypes.bool, // to show order of an option
	...
	componentDidUpdate: function componentDidUpdate(prevProps, prevState) {
		if (this.menu) {
			if (this.menu.className.indexOf('ps-container') === -1) {
				_perfectScrollbar2['default'].initialize(this.menu);
			} else {
				_perfectScrollbar2['default'].update(this.menu);
			}
		}
			...
			return valueArray.map(function (value, i) {
				return _react2['default'].createElement(
					ValueComponent,
					{
						...
						value: value,
						position: _this4.props.positionValue ? i : null
					},
					renderLabel(value, i),
